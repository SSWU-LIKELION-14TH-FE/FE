...
const Section03 = () => {
    return (
        <div className='Section03_wrap'>
            <div>
                <img src={Img01} alt="1번" />
                <div>
                    <p className='tage'>VISION</p>
                    <h2>IT 교육 기회를 제공하여 <br /> 꿈꾸던 가능성을 열어준다.</h2>
                    <p>Open up the possibility of dreaming by providing <br/>
            ...
            <div>
                <div className='right'>
                    ...
                    <p>Solve IT education problems using IT <dr/>
                    technology.</p>
                </div>
                <img src={Img02} alt="2번" />
            </div>

            <div>
                <img src={Img03} alt="3번" />
                <div>
                    <p className='tage'>VISION</p>
                    <h2>지속 성장이 가능한 IT <br />커뮤니티를 구축한다.</h2>
                    <p>Establish an IT community that can sustain <br/>
                    growth.</p>
                </div>
